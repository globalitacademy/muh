      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            <Card key={index} className="text-center p-8 course-card-hover border-0 shadow-lg">
              <CardContent className="pt-6">
                <div className="w-16 h-16 mx-auto mb-6 bg-edu-blue text-white rounded-full flex items-center justify-center">
                  {feature.icon}
                </div>
