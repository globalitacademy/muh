    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      cards.forEach((card, index) => {
        ...
        (card as HTMLElement).style.transform = 
          `perspective(1000px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) translateZ(${influence * 20}px)`;
      });
    };
    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-background w-full relative overflow-hidden">
      ...
      <div className="content-container relative z-10">
        ...
        <ScrollReveal delay={800}>
          <div className="text-center mt-16 sm:mt-20 w-full">
            <div className="glass-card rounded-3xl p-8 sm:p-10 bg-card/40 backdrop-blur-xl border border-border/20 shadow-2xl relative overflow-hidden group hover:shadow-edu-blue/20 transition-all duration-500">
              {/* Background animation */}
              <div className="absolute inset-0 bg-gradient-to-br from-edu-blue/5 via-transparent to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-edu-blue/10 text-edu-blue mb-6 backdrop-blur-sm">
