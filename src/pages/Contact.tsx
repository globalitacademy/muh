    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 -left-20 w-80 h-80 bg-gradient-to-br from-edu-blue/20 to-purple-500/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 -right-20 w-80 h-80 bg-gradient-to-br from-edu-orange/20 to-pink-500/20 rounded-full blur-3xl"></div>
        </div>
        ...
        <section className="relative py-20 px-4">
          <div className="container mx-auto text-center">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-5xl md:text-7xl font-bold mb-6 font-armenian">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 font-armenian leading-relaxed">
                {language === 'hy' 
            ...
            <div className="grid lg:grid-cols-2 gap-16 max-w-7xl mx-auto">
              ...
              <div className="space-y-8">
                <div className="text-center lg:text-left">
                  <h2 className="text-3xl md:text-4xl font-bold mb-6 font-armenian text-foreground">
                    ...
                    <div key={index} className="group">
                      <div className="glass-card p-6 rounded-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
                        <div className="flex items-start space-x-4">
                          <div className={`w-14 h-14 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center flex-shrink-0 text-white group-hover:scale-110 transition-transform duration-300`}>
                            {item.icon}
                          </div>
                          <div className="flex-1">
                            <h3 className="font-semibold text-lg font-armenian text-foreground mb-2">{item.title}</h3>
              ...
              <div>
                <Card className="glass-card border-0 shadow-2xl rounded-2xl overflow-hidden">
                  <CardHeader className="bg-gradient-to-br from-edu-blue/5 to-purple-500/5 border-b border-border/50">
                    <CardTitle className="text-2xl md:text-3xl font-armenian text-foreground flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-edu-blue to-purple-500 rounded-xl flex items-center justify-center text-white">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <Label htmlFor="name" className="font-armenian text-foreground font-medium">
                          ...
                          <Input
                            ...
                            required
                            className="h-12 rounded-xl border-border/50 focus:border-edu-blue transition-colors"
                            placeholder={language === 'hy' ? 'Ձեր անունը' : language === 'ru' ? 'Ваше имя' : 'Your name'}
                          />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="email" className="font-armenian text-foreground font-medium">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="subject" className="font-armenian text-foreground font-medium">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="message" className="font-armenian text-foreground font-medium">
                        ...
                        <Textarea
                          ...
                          required
                          rows={5}
                          className="rounded-xl border-border/50 focus:border-edu-blue transition-colors resize-none"
                      ...
                      <Button 
                        type="submit" 
                        className="w-full h-12 bg-gradient-to-r from-edu-blue to-purple-500 hover:from-edu-dark-blue hover:to-purple-600 font-armenian font-semibold text-white rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg"
                      >
        ...
        <section className="relative py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground font-armenian">
                {language === 'hy' 
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={index} className="glass-card p-6 rounded-2xl hover:scale-105 transition-transform duration-300">
                  <h3 className="font-semibold text-lg font-armenian text-foreground mb-3">{faq.q}</h3>
                  <p className="text-muted-foreground font-armenian">{faq.a}</p>
                </div>
              ))}
            </div>
          </div>
