...
const translations = {
  hy: {
    ...
    // Auth page
    'auth.back-to-home': 'Վերադառնալ գլխավոր էջ',
    'auth.welcome': 'Բարի գալուստ',
    'auth.subtitle': 'Մուտք գործեք կամ ստեղծեք նոր հաշիվ',
    'auth.signin': 'Մուտք',
    'auth.signup': 'Գրանցում',
    'auth.email': 'Էլ. փոստ',
    'auth.password': 'Գաղտնաբառ',
    'auth.signin-button': 'Մուտք գործել',
    'auth.name': 'Անուն',
    'auth.name-placeholder': 'Ձեր անունը',
    'auth.role': 'Դեր',
    'auth.role-placeholder': 'Ընտրեք դեր',
    'auth.role-student': 'Ուսանող',
    'auth.role-instructor': 'Դասախոս',
    'auth.role-employer': 'Գործատու',
    'auth.role-partner': 'Գործընկեր',
    'auth.group-number': 'Խմբի համար',
    'auth.group-number-placeholder': 'Ձեր խմբի համարը',
    'auth.institution-name': 'Ուսումնական հաստատության անունը',
    'auth.institution-name-placeholder': 'Մուտքագրեք հաստատության անունը',
    'auth.director-name': 'Տնօրենի անունը',
    'auth.director-name-placeholder': 'Մուտքագրեք տնօրենի անունը',
    'auth.address': 'Հասցե',
    'auth.address-placeholder': 'Մուտքագրեք հասցեն',
    'auth.phone': 'Հեռախոսահամար',
    'auth.phone-placeholder': 'Մուտքագրեք հեռախոսահամարը',
    'auth.organization-name': 'Կազմակերպության անվանում',
    'auth.organization-name-placeholder': 'Մուտքագրեք կազմակերպության անվանումը',
    'auth.manager-name': 'Տնօրեն',
    'auth.manager-name-placeholder': 'Մուտքագրեք տնօրենի անունը',
    'auth.create-account': 'Ստեղծել հաշիվ',
  ...
  ru: {
    ...
    // Auth page
    'auth.back-to-home': 'Вернуться на главную',
    'auth.welcome': 'Добро пожаловать',
    'auth.subtitle': 'Войдите или создайте новый аккаунт',
    'auth.signin': 'Вход',
    ...
    'auth.role': 'Роль',
    'auth.role-placeholder': 'Выберите роль',
    'auth.role-student': 'Студент',
    'auth.role-instructor': 'Преподаватель',
    'auth.role-employer': 'Работодатель',
    'auth.role-partner': 'Партнер',
    'auth.group-number': 'Номер группы',
    'auth.group-number-placeholder': 'Ваш номер группы',
    'auth.institution-name': 'Название учебного заведения',
    'auth.institution-name-placeholder': 'Введите название учреждения',
    'auth.director-name': 'Имя директора',
    'auth.director-name-placeholder': 'Введите имя директора',
    'auth.address': 'Адрес',
    'auth.address-placeholder': 'Введите адрес',
    'auth.phone': 'Телефон',
    'auth.phone-placeholder': 'Введите номер телефона',
    'auth.organization-name': 'Название организации',
    'auth.organization-name-placeholder': 'Введите название организации',
    'auth.manager-name': 'Руководитель',
    'auth.manager-name-placeholder': 'Введите имя руководителя',
  ...
  en: {
    ...
    'auth.role': 'Role',
    'auth.role-placeholder': 'Select role',
    'auth.role-student': 'Student',
    'auth.role-instructor': 'Instructor',
    'auth.role-employer': 'Employer',
    'auth.role-partner': 'Partner',
    'auth.group-number': 'Group Number',
    'auth.group-number-placeholder': 'Your group number',
    'auth.institution-name': 'Institution Name',
    'auth.institution-name-placeholder': 'Enter institution name',
    'auth.director-name': 'Director Name',
    'auth.director-name-placeholder': 'Enter director name',
    'auth.address': 'Address',
    'auth.address-placeholder': 'Enter address',
    'auth.phone': 'Phone',
    'auth.phone-placeholder': 'Enter phone number',
    'auth.organization-name': 'Organization Name',
    'auth.organization-name-placeholder': 'Enter organization name',
    'auth.manager-name': 'Manager',
    'auth.manager-name-placeholder': 'Enter manager name',
